  ...
  useEffect( ()=>{
	...
	const ComponentPdf1 = useRef();
		...
		return (
	      ...
	      <SearchbarSales/>
				<div className=" {`box ${selectedStyle || ''}`} " id='themebtn' onClick={toggleDropdown}  >SelectTheme
				<TbHandClick />
					{isOpen && (
	...
	<div className="generate-pdf-button" onClick={handleGeneratePDFClick}  >Share
						...
						<div className="generate-pdf-button" onClick={handleGeneratePDFClick} >SavePDF
						<RiFileDownloadLine />
					</div>
     ...
     <div className='two_chartmonth'>
     <BarChart data={monthdata} />
     </div>
     <div className='two_chartyear'>
...
{/* 	
					...
					<h2 style={{}}>PRODUCTS SALES INVOICE</h2>
				...
				<h1 className='orderdetails'>Revenue Details </h1>
