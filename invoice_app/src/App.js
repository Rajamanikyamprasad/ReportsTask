...
import MonthlyChart from './components/reports/visible';
   ...
   <div className='icondiv'>
    ...
    <div className={`app-container ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className="sidebar" >
          ...
          <hr></hr>
          <li onClick={() => handleNavItemClick('home')}>Manage Orders</li>
          <hr></hr>
          <li >
          ...
          <hr></hr>
          <li onClick={() => handleNavItemClick('home')}>Inventory</li>
          <hr></hr>
          <li onClick={() => handleNavItemClick('home')}>Update Products</li>
